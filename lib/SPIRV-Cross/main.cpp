...
static void print_help_hlsl()
{
	...
	fprintf(stderr, "\nHLSL options:\n"
	                ...
	                "\t\tDo not emit any : register(#) bindings for specific memory types, and rely on HLSL compiler to assign something.\n"
...
static void print_help_msl()
{
	...
	fprintf(stderr, "\nMSL options:\n"
	                ...
	                "\t[--msl-argument-buffers]:\n\t\tEmit Metal argument buffers instead of discrete memory bindings.\n"
	                ...
	                "\t\tThis makes sure that similar shaders with same memory declarations can share the argument buffer as declaring an argument buffer implies an ABI.\n"
	                ...
	                "\t[--msl-check-discarded-frag-stores]:\n\t\tAdd additional checks to memory stores in a fragment shader.\n"
...
static HLSLBindingFlags hlsl_resource_type_to_flag(const std::string &arg)
{
	...
	{
		fprintf(stderr, "Invalid memory type for --hlsl-auto-binding: %s\n", arg.c_str());
		return 0;
	}
}
