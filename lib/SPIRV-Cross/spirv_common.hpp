...
enum ExtendedDecorations
{
	...
	// Used for decorations like memory indices for samplers when part of combined image samplers.
	// A variable might need to hold two memory indices in this case.
	SPIRVCrossDecorationResourceIndexSecondary,
	// Used for memory indices for multiplanar images when part of combined image samplers.
