...
void CompilerGLSL::replace_illegal_names()
{
	...
	static const unordered_set<string> keywords = {
		...
		"memory", "restrict", "return", "sample", "sampler1D", "sampler1DArray", "sampler1DArrayShadow",
...
void CompilerGLSL::convert_non_uniform_expression(string &expr, uint32_t ptr_id)
{
	...
	// If we get here, we know we're accessing an arrayed memory which
