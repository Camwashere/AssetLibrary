...
Options:
  ...
  -flimit=<settings>
                    Specify memory limits. Each limit is specified by a limit
  ...
  -fimage-binding-base [stage] <value>
                    ...
                    For HLSL, the memory register number is added to this
                    base.
...
// Sets memory limits according to the given string. The string
