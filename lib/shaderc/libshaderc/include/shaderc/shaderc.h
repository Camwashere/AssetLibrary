...
typedef enum {
  ...
  // Sampled texture in GLSL, and Shader Asset View in HLSL.
...
// Sets the base binding number used for for a uniform memory type when
...
// assigned to the memory is added to this specified base.
